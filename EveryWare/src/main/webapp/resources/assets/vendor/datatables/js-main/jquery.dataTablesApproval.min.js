...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"첫 페이지",sLast:"마지막 페이지",sNext:"다음",sPrevious:"이전"},sEmptyTable:"해당되는 결재가 없습니다.",sInfo:"총 _TOTAL_ 개의 전자결재  중 _START_ 번 ~ _END_ 번",sInfoEmpty:"해당되는 결재가 없습니다.",sInfoFiltered:"(총 _MAX_ 개의 전자결재 중 검색한 결과.)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"_MENU_ 개씩 보기",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"검색:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"검색결과가 없습니다."},
