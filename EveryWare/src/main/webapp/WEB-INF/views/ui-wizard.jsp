...
<html>
	<head>
		<title>Wizard | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
	...
	<body>
						...
						<li class="panel">
							...
							<div id="uiElements" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="ui-wizard" class="active">Wizard</a></li>
		...
		<script src="resources/assets/vendor/fuelux/wizard/wizard.js"></script>
