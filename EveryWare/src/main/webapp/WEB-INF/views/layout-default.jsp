...
<html>
	<head>
		<title>Layout Default | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
						...
						<li class="panel">
							...
							<div id="subLayouts" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="layout-default" class="active">Default</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Layout Default</li>
						</ul>
					</div>
					<div class="container-fluid">
