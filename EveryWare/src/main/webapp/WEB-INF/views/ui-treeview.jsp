...
<html>
	<head>
		<title>Tree View | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" href="resources/assets/vendor/jstree/themes/default/style.css">
		<!-- MAIN CSS -->
	...
	<body>
						...
						<li class="panel">
							...
							<div id="uiElements" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="ui-treeview" class="active">Tree View</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							...
							<p class="page-subtitle">Interactive trees, easily extendable, themable and configurable. Try to right click node item to see popup menu.</p>
						</div>
						<ul class="breadcrumb">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="panel" style="min-height: 450px;">
									...
									<div class="panel-body">
										<div id="treeview-custom-icon" class="custom-tree"></div>
									</div>
								</div>
							</div>
							<div class="col-md-4">
		...
		<script src="resources/assets/vendor/jstree/jstree.js"></script>
		...
		$(function()
		{
			...
			treeviewDefault.jstree(
			{
				'core':
				{
					'data':
					{
						'url': 'resources/assets/scripts/tree/tree-default.json',
					},
					'check_callback': true,
				},
			...
			treeviewCustomIcon.jstree(
			{
				'core':
				{
					'data':
					{
						'url': 'resources/assets/scripts/tree/tree-filesystem.json',
					},
					'check_callback': true,
				},
			...
			treeviewApp.jstree(
			{
				'core':
				{
					'data':
					{
						'url': 'resources/assets/scripts/tree/tree-application.json',
					},
					'check_callback': true,
				},
