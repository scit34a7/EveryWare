...
<html>
	<head>
		<title>Layout Fullwidth | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
	...
	<body class="layout-default layout-fullwidth">
		<!-- WRAPPER -->
		<div id="wrapper">
			<!-- NAVBAR -->
						...
						<li class="panel">
							...
							<div id="subLayouts" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="layout-fullwidth" class="active">Fullwidth</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Layout Fullwidth</h1>
							<p class="page-subtitle">Click the thumbnail to see other layouts.</p>
						</div>
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i> Home</a></li>
							<li><a href="#">Layouts</a></li>
							<li class="active">Layout Fullwidth</li>
						</ul>
					</div>
					<div class="container-fluid">
						<div class="row margin-top-50 demo-layout">
							<div class="col-md-6">
