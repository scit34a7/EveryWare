...
<html>
	<head>
		<title>Notifications | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" href="resources/assets/vendor/toastr/toastr.min.css">
		<!-- MAIN CSS -->
	...
	<body>
			...
			<div id="sidebar-nav" class="sidebar">
				<nav>
					<ul class="nav" id="sidebar-nav-menu">
						...
						<li><a href="notifications" class="active"><i class="ti-bell"></i> <span class="title">Notifications</span> <span class="badge">15</span></a></li>
						<li class="panel">
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							...
							<p class="page-subtitle">Customizable and stylish Gnome/Growl type non-blocking notifications.</p>
						</div>
						<ul class="breadcrumb">
		...
		<script src="resources/assets/vendor/toastr/toastr.min.js"></script>
