...
<html>
	<head>
		<title>Maps by jQuery Mapael | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
	...
	<body>
						...
						<li class="panel">
							...
							<div id="maps" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="maps-mapael" class="active">Mapael</a></li>
								</ul>
							</div>
						</li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Maps by jQuery Mapael</h1>
							<p class="page-subtitle">Ease the build of pretty data visualizations on dynamic vector maps.</p>
						</div>
						<ul class="breadcrumb">
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Map with Zoom</h3>
									</div>
									<div class="panel-body">
										<p>
											<small>Use mouse wheel to control zoom level or use buttons + and -</small>
										</p>
										<div id="zoom-map">
											<div class="map"></div>
										</div>
							...
							<div class="col-md-8">
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Basic Map</h3>
									</div>
									<div class="panel-body">
										<div id="basic-map">
											<div class="map"></div>
		...
		<script src="resources/assets/vendor/jquery-mapael/js/jquery.mapael.min.js"></script>
		<script src="resources/assets/vendor/jquery-mapael/js/maps/world_countries.min.js"></script>
		<script src="resources/assets/vendor/jquery-mapael/js/maps/france_departments.js"></script>
		<script src="resources/assets/vendor/jquery-mousewheel/jquery.mousewheel.js"></script>
