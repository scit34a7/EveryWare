...
<html>
	<head>
		<title>Input Pickers | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" href="resources/assets/vendor/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
	...
	<body>
						...
						<li class="panel">
							...
							<div id="forms" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="forms-input-pickers" class="active">Input Pickers</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Input Pickers</h1>
							<p class="page-subtitle">Datepicker, color picker, time picker</p>
						</div>
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i> Home</a></li>
							<li><a href="#">Forms</a></li>
							<li class="active">Input Pickers</li>
						</ul>
					</div>
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="panel">
									...
									<div class="panel-body">
										...
										<br>
										<br>
										<label>Working With Event</label>
										<br>
		...
		<script src="resources/assets/vendor/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js"></script>
