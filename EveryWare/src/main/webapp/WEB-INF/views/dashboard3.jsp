						...
						<li class="panel">
							...
							<div id="dashboards" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="dashboard3" class="active">Dashboard v3</a></li>
												...
												<div role="tabpanel" class="tab-pane active" id="following">
													<ul class="list-unstyled list-positions">
														<li class="position up clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/male1.png" class="user-picture" alt="">
														...
														<li class="position up clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/female1.png" class="user-picture" alt="">
														...
														<li class="position up clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/male2.png" class="user-picture" alt="">
														...
														<li class="position down clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/female2.png" class="user-picture" alt="">
														...
														<li class="position down clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/female3.png" class="user-picture" alt="">
												...
												<div role="tabpanel" class="tab-pane" id="global">
													<ul class="list-unstyled list-positions">
														<li class="position up clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/male3.png" class="user-picture" alt="">
																	<span class="position-number">1</span>
																</div>
																<div class="right">
														...
														<li class="position up clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/female4.png" class="user-picture" alt="">
																	<span class="position-number">2</span>
																</div>
																<div class="right">
														...
														<li class="position up clearfix">
															...
															<div class="account">
																<div class="user">
																	<img src="resources/assets/img/people/male4.png" class="user-picture" alt="">
																	<span class="position-number">3</span>
																</div>
																<div class="right">
