...
<html>
	<head>
		<title>Form Layouts | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
						...
						<li class="panel">
							...
							<div id="forms" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="forms-layouts" class="active">Form Layouts</a></li>
							...
							<div class="col-md-6">
										...
										<form class="form-horizontal" role="form">
											<fieldset>
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<select id="ticket-priority" name="ticket-priority" class="form-control">
								...
								<div class="panel">
									...
									<div class="panel-body">
										...
										<form>
											<div class="form-group">
												<label for="username2" class="control-label sr-only">Username</label>
											...
											<div class="form-group">
												<label class="fancy-checkbox custom-bgcolor-blue">
													<input type="checkbox">
													<span class="text-muted">Remember me next time</span>
												</label>
											</div>
									...
									<div class="panel-body">
										<form>
											...
											<div class="form-group">
												...
												<textarea class="form-control" id="contact-message" name="contact-message" rows="5" cols="30" placeholder="Message"></textarea>
											</div>
								...
								<div class="panel">
									...
									<div class="panel-body">
										...
										<form class="form-horizontal label-left">
											...
											<button type="submit" class="btn btn-primary btn-lg center-block"><i class="fa fa-sign-in"></i>
												<span>Sign In</span>
											</button>
										</form>
									</div>
