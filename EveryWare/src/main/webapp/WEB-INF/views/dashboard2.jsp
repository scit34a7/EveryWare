						...
						<li class="panel">
							...
							<div id="dashboards" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="dashboard2" class="active">Dashboard v2</a></li>
								...
								<div class="table-responsive">
									<table class="table top-products no-margin">
										...
										<tbody>
											<tr>
												<td>
													<img src="resources/assets/img/products/puzzle.png" class="product-logo" alt="Puzzle">
											...
											<tr>
												<td>
													<img src="resources/assets/img/products/qrcode.png" class="product-logo" alt="QRCode">
											...
											<tr>
												<td>
													<img src="resources/assets/img/products/easypolls.png" class="product-logo" alt="Easy Polls">
							...
							<table class="table table-minimal project-list">
								...
								<tbody>
									<tr>
										...
										<td class="leader">
											<a href="#">
												<img src="resources/assets/img/user2.png" alt="Avatar" class="avatar img-circle" />
												<span>Michael</span>
											</a>
										</td>
										<td>
									...
									<tr>
										...
										<td class="leader">
											<a href="#">
												<img src="resources/assets/img/user1.png" alt="Avatar" class="avatar img-circle" />
												<span>Antonius</span>
											</a>
										</td>
										<td>
									...
									<tr>
										...
										<td class="leader">
											<a href="#">
												<img src="resources/assets/img/user5.png" alt="Avatar" class="avatar img-circle" />
												<span>Jason</span>
											</a>
										</td>
										<td>
