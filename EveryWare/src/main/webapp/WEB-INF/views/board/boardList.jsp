			...
			<!-- FEATURED DATATABLE / 본문 시작-->
				...
				<div class="panel">
					...
					<%-- <p class="alert alert-info">전체 : ${navi.totalRecordsCount}</p> --%>
						<p style="text-align:right"><input type="button" value="글쓰기" class="btn btn-info" onClick="location.href='write?boardFolder_id=${boardFolder_id}';">
						</p>
