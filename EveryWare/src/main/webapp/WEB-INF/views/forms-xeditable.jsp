...
<html>
	<head>
		<title>X-editable In-place Editing | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" href="resources/assets/vendor/x-editable/inputs-ext/typeaheadjs/lib/typeahead.js-bootstrap.css">
		<link rel="stylesheet" href="resources/assets/vendor/x-editable/inputs-ext/address/address.css">
		<!-- MAIN CSS -->
	...
	<body>
						...
						<li class="panel">
							...
							<div id="forms" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="forms-xeditable" class="active">In-place Editing</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">X-editable In-place Editing</h1>
							<p class="page-subtitle">In-place editing, allows you to create editable elements on your page.</p>
						</div>
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i> Home</a></li>
							<li><a href="#">Forms</a></li>
							<li class="active">X-editable In-place Editing</li>
						</ul>
					</div>
					<div class="container-fluid">
						...
						<form id="editable-options" class="margin-bottom-30">
							...
							<label class="fancy-radio custom-color-green">
								<input name="mode" value="Popup" type="radio" checked>
								<span><i></i>Popup</span>
							</label>
							<label class="fancy-radio custom-color-green">
								<input name="mode" value="Inline" type="radio">
								<span><i></i>Inline</span>
							</label>
						</form>
						<table id="editable-demo" class="table table-bordered table-striped" style="width: 800px;">
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="#" id="combodate" data-type="combodate" data-value="1984-05-23" data-format="YYYY-MM-DD" data-viewformat="DD/MM/YYYY" data-template="D / MMM / YYYY" data-pk="1" data-title="Select Date of birth"></a>
									</td>
								</tr>
								<tr>
		...
		<script src="resources/assets/vendor/x-editable/inputs-ext/typeaheadjs/lib/typeahead.js"></script>
		<script src="resources/assets/vendor/x-editable/inputs-ext/typeaheadjs/typeaheadjs.js"></script>
		<script src="resources/assets/vendor/x-editable/inputs-ext/address/address.js"></script>
		...
		<!-- END DEMO PANEL -->
		<script src="resources/assets/scripts/jquery.mockjax.min.js"></script>
		<script src="resources/assets/scripts/demo-mock.js"></script>
		<script>
		$(function()
		{
			//defaults
			...
			$('#address').editable(
			{
				...
				display: function(value)
				{
					...
					var html = '<b>' + $('<div>').text(value.city)() + '</b>, ' + $('<div>').text(value.street)() + ' st., bld. ' + $('<div>').text(value.building)();
					$(this)(html);
				}
			});
