...
<html>
	<head>
		<title>Layout Minified | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Layout Minified</h1>
					...
					<div class="container-fluid">
						<div class="row demo-layout margin-top-50">
							<div class="col-md-6">
