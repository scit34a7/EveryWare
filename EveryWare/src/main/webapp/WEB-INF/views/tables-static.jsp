...
<html>
	<head>
		<title>Static Tables | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
					...
					<ul class="nav" id="sidebar-nav-menu">
						...
						<li class="panel">
							...
							<div id="tables" class="collapse in">
								<ul class="submenu">
									<li><a href="tables-static" class="active">Static Tables</a></li>
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Minimal Table</h3>
									</div>
									<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Table Fullwidth</h3>
									</div>
