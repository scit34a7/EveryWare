...
<html>
	<head>
		<title>Select2 | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" href="resources/assets/vendor/select2/css/select2.min.css">
		<!-- MAIN CSS -->
	...
	<body>
						...
						<li class="panel">
							...
							<div id="forms" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="forms-select2" class="active">Select2</a></li>
						...
						<li class="panel">
							...
							<div id="appViews" class="collapse ">
								<ul class="submenu">
									...
									<li><a href="appviews_file_manager">File Manager</a></li>
								</ul>
							</div>
						</li>
						<li class="panel">
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Select2</h1>
							<p class="page-subtitle">The jQuery replacement for select boxes</p>
						</div>
						<ul class="breadcrumb">
		...
		<script src="resources/assets/vendor/select2/js/select2.min.js"></script>
