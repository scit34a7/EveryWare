...
<html>
	<head>
		<title>Drag &amp; Drop Panel | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
						...
						<li class="panel">
							...
							<div id="uiElements" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="ui-dragdrop-panel" class="active">Drag &amp; Drop Panel</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Drag &amp; Drop Panel</h1>
							<p class="page-subtitle">Reorder panels in layout with drag and drop feature</p>
						</div>
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i> Home</a></li>
							<li><a href="#">UI Elements</a></li>
							<li class="active">Drag &amp; Drop Panel</li>
						</ul>
					</div>
					<div class="container-fluid">
							...
							<div class="col-md-6 sortable-item">
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Draggable Panel 1</h3>
										<div class="right">
