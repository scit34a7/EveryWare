...
<html>
	<head>
		<title>Bootstrap UI | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
						...
						<li class="panel">
							...
							<div id="uiElements" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="ui-bootstrap" class="active">Bootstrap UI</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Bootstrap UI</h1>
							<p class="page-subtitle">Custom styled standard Bootstrap UI.</p>
						</div>
						<ul class="breadcrumb">
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="panel">
									...
									<div class="panel-body">
										...
										<br>
										<br>
										<span class="label label-default label-transparent">DEFAULT</span>
										<span class="label label-primary label-transparent">PRIMARY</span>
										<span class="label label-success label-transparent">SUCCESS</span>
										<span class="label label-info label-transparent">INFO</span>
										<span class="label label-warning label-transparent">WARNING</span>
										<span class="label label-danger label-transparent">DANGER</span>
										<br>
										<br>
							...
							<div class="col-md-6">
								...
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Tooltips, Popovers, Modals</h3>
									</div>
									<div class="panel-body">
										<h4>Tooltips</h4>
										...
										<div class="margin-botttom-30"></div>
										<h4>Popovers</h4>
										<p class="demo-button">
										...
										<div id="small-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
											<div class="modal-dialog modal-sm" role="document">
												<div class="modal-content">
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														<h4 class="modal-title" id="myModalLabel2">Small Modal Title</h4>
													</div>
													<div class="modal-body">
														<p>Modal dialog content...</p>
													</div>
