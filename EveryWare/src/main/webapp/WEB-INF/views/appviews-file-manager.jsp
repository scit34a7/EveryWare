...
<html>
	<head>
		<title>File Manager | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
						...
						<li class="panel">
							...
							<div id="appViews" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="appviews-file-manager" class="active">File Manager</a></li>
								</ul>
							</div>
						</li>
						<li class="panel">
					...
					<div class="content-heading clearfix">
						<div class="heading-left">
							...
							<p class="page-subtitle">
								<span class="text-danger">You nearly reached storage limit capacity!</span>&nbsp;&nbsp;&nbsp;<a href="#"><i class="fa fa-plus-circle"></i> Upgrade Now</a></p>
						</div>
						<ul class="breadcrumb">
								...
								<div class="content-menu clearfix">
									<div class="content-menu-left">
										<div class="margin-bottom-30">
											<button type="button" class="btn btn-block btn-lg btn-success"><i class="fa fa-cloud-upload"></i> UPLOAD FILES</button>
										</div>
										<nav>
											<span>FOLDERS <a href="#"><i class="fa fa-plus-circle"></i></a></span>
											<ul class="nav-content-menu">
												<li><a href="#"><i class="fa fa-folder"></i> My Folders</a></li>
												<li><a href="#"><i class="fa fa-users"></i> Shared</a></li>
												<li><a href="#"><i class="fa fa-heart"></i> Favorites</a></li>
												<li><a href="#"><i class="fa fa-star"></i> Starred</a></li>
												<li><a href="#"><i class="fa fa-trash"></i> Trash</a></li>
											</ul>
											<span>TAGS <a href="#"><i class="fa fa-plus-circle"></i></a></span>
											<ul class="list-unstyled nav-content-menu">
												<li class="file-tag tag-orange"><a href="#">Home</a></li>
												<li class="file-tag tag-blue"><a href="#">Personal</a></li>
												<li class="file-tag tag-seagreen"><a href="#">Work</a></li>
												<li class="file-tag tag-purple"><a href="#">Friends</a></li>
											</ul>
										</nav>
									</div>
								</div>
								<div class="storage-info">
									<span class="title">Storage Plan: Gold</span>
									...
									<span class="usage-text">12 of 15 GB used</span>&nbsp;&nbsp;&nbsp;<a href="#"><i class="fa fa-plus-circle"></i> Upgrade Now</a>
								</div>
							</div>
							<div class="col-lg-9">
								<div class="content-right clearfix">
									<ul class="list-unstyled list-files">
										...
										<li class="file-item">
											<a href="#">
												<span class="file-preview image">
													<img src="resources/assets/img/files/file-image.jpg" class="img-responsive" alt="">
												</span>
											</a>
											<div class="file-info">
												<a href="#">
													<span class="file-name">header_banner.jpg</span>
												</a>
												<span class="file-date">Added 11 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
										...
										<li class="file-item">
											...
											<div class="file-info">
												<a href="#">
													<span class="file-name">export-data.xls</span>
												</a>
												<span class="file-date">Added 12 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="#"><i class="fa fa-cloud-download"></i> Download</a></li>
										...
										<li class="file-item">
											<a href="#">
												<span class="file-preview audio">
													<i class="fa fa-music"></i>
													<span class="file-extension">.mp3</span>
												</span>
											</a>
											<div class="file-info">
												<a href="#">
													<span class="file-name">notification_sound.mp3</span>
												</a>
												<span class="file-date">Added 12 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
										...
										<li class="file-item">
											<a href="#">
												<span class="file-preview image">
													<img src="resources/assets/img/files/file-image2.png" class="img-responsive" alt="">
												</span>
											</a>
											<div class="file-info">
												<a href="#">
													<span class="file-name">top-background.png</span>
												</a>
												<span class="file-date">Added 8 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="#"><i class="fa fa-cloud-download"></i> Download</a></li>
										...
										<li class="file-item">
											<a href="#">
												<span class="file-preview doc">
													<i class="fa fa-file-word-o"></i>
													<span class="file-extension">.doc</span>
												</span>
											</a>
											<div class="file-info">
												<a href="#">
													<span class="file-name">PurchaseDocument.doc</span>
												</a>
												<span class="file-date">Added 12 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
										...
										<li class="file-item">
											<a href="#">
												<span class="file-preview">
													...
													<span class="file-extension">.dat</span>
												</span>
											</a>
											<div class="file-info">
												<a href="#">
													<span class="file-name">backup-data.dat</span>
												</a>
												<span class="file-date">Added 10 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="#"><i class="fa fa-cloud-download"></i> Download</a></li>
										...
										<li class="file-item">
											<a href="#">
												<span class="file-preview image">
													<img src="resources/assets/img/files/file-image3.jpg" class="img-responsive" alt="">
												</span>
											</a>
											<div class="file-info">
												<a href="#">
													<span class="file-name">footer-image.jpg</span>
												</a>
												<span class="file-date">Added 8 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
										...
										<li class="file-item">
											<a href="#">
												<span class="file-preview video">
													<i class="fa fa-file-video-o"></i>
													<span class="file-extension">.avi</span>
												</span>
											</a>
											<div class="file-info">
												<a href="#">
													<span class="file-name">company_profile.avi</span>
												</a>
												<span class="file-date">Added 10 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
										...
										<li class="file-item">
											...
											<div class="file-info">
												<a href="#">
													<span class="file-name">export-data071107.xls</span>
												</a>
												<span class="file-date">Added 4 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="#"><i class="fa fa-cloud-download"></i> Download</a></li>
										...
										<li class="file-item">
											...
											<div class="file-info">
												<a href="#">
													<span class="file-name">Proposal_draft.pdf</span>
												</a>
												<span class="file-date">Added 2 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
													<ul class="dropdown-menu dropdown-menu-right">
														<li><a href="#"><i class="fa fa-cloud-download"></i> Download</a></li>
										...
										<li class="file-item">
											...
											<div class="file-info">
												<a href="#">
													<span class="file-name">License.doc</span>
												</a>
												<span class="file-date">Added 2 Jun 2017</span>
												<div class="dropdown">
													<a href="#" class="toggle-dropdown" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i></a>
