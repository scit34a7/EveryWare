...
<html>
	<head>
		<title>Nestable | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" href="resources/assets/vendor/nestable2/jquery.nestable.css">
		<!-- MAIN CSS -->
	...
	<body>
		...
		<div id="wrapper">
						...
						<li class="panel">
							...
							<div id="uiElements" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="ui-nestable" class="active">Nestable</a></li>
			...
			<div class="main">
				...
				<div class="main-content">
					...
					<div class="container-fluid">
						<p>
							<button id="btn-expand" class="btn btn-primary">Expand All</button>
							<button id="btn-collapse" class="btn btn-primary">Collapse All</button>
						</p>
						<br>
						<div class="row">
							<div class="col-md-6">
		...
		<script src="resources/assets/vendor/nestable2/jquery.nestable.js"></script>
