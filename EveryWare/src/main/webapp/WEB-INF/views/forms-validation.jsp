						...
						<li class="panel">
							...
							<div id="forms" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="forms-validation" class="active">Form Validation</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							...
							<p class="page-subtitle">Form validation with Parsley, validating forms frontend have never been so powerful and easy.</p>
						</div>
						<ul class="breadcrumb">
							...
							<div class="col-md-6">
								<div class="panel">
									<div class="panel-heading">
										<h3 class="panel-title">Basic Validations</h3>
									</div>
								...
								<div class="panel">
									...
									<div class="panel-body">
										<form id="advanced-form" data-parsley-validate novalidate>
											...
											<div class="form-group">
												<label class="control-label">Select Between 1-2 Options</label>
												<br />
												<label class="control-inline fancy-checkbox">
