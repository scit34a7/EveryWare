...
<html>
	<head>
		<title>Input Sliders | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
		...
		<link rel="stylesheet" href="resources/assets/vendor/bootstrap-slider/slider.css">
		<link rel="stylesheet" href="resources/assets/vendor/nouislider/css/nouislider.min.css">
		<!-- MAIN CSS -->
	...
	<body>
						...
						<li class="panel">
							...
							<div id="forms" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="forms-input-sliders" class="active">Input Sliders</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">Input Sliders</h1>
							<p class="page-subtitle">Input slider, range input slider, stepped input slider</p>
						</div>
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i> Home</a></li>
							<li><a href="#">Forms</a></li>
							<li class="active">Input Sliders</li>
						</ul>
					</div>
					<div class="container-fluid">
						<!-- RANGE SLIDER INPUT -->
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">Input Slider
									<small>by <a href="https://refreshless.com/nouislider/">noUiSlider</a></small>
								</h3>
							</div>
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<div id="nouislider1"></div>
										<br>
										<span>Provide number between 0 to 1000 then hit enter</span>
										<input id="input-nouislider1">
										<br>
										<br>
										<br>
										<div id="nouislider2"></div>
										<br>
										<span>Provide number between 2.000 to 50.000 then hit enter, you can ignore '$' sign</span>
										<br>
										<input id="input-nouislider2">
										<br>
										<br>
										<br>
										<br>
										<span>Range slider with tooltips</span>
										<br>
										<br>
										<br>
										<div id="nouislider3"></div>
										<br>
										<br>
									</div>
									<div class="col-md-6">
										<span>Slider with step</span>
										<br>
										<br>
										<div id="nouislider4"></div>
										<br>
										<br>
										<span>Draggable range, drag the green area</span>
										<br>
										<br>
										<div id="nouislider5"></div>
										<br>
										<br>
										<span>Fixed draggable range with fixed handles</span>
										<br>
										<br>
										<div id="nouislider6"></div>
										<br>
										<br>
										<span>Default, basic slider</span>
										<br>
										<br>
										<div id="nouislider7"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">Input Slider
									<small>by <a href="http://www.eyecon.ro/bootstrap-slider/">Bootstrap Slider</a></small>
								</h3>
							</div>
							<div class="panel-body">
								<div class="slider-has-label">
									...
									<div class="right-label">
										<span class="label label-default label-slider pull-right"></span>
									</div>
								</div>
		...
		<script src="resources/assets/vendor/bootstrap-slider/bootstrap-slider.js"></script>
		<script src="resources/assets/vendor/wnumb/wNumb.js"></script>
		<script src="resources/assets/vendor/nouislider/js/nouislider.min.js"></script>
		...
		{
			/*-----------------------------------/
			/*	SLIDER INPUTS (Bootstrap Slider)
			/*----------------------------------*/
