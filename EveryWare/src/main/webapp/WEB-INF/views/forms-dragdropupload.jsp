...
<html>
	<head>
		<title>Drag &amp; Drop File Upload | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
						...
						<li class="panel">
							...
							<div id="forms" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="forms-dragdropupload" class="active">Drag and Drop Upload</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							...
							<p class="page-subtitle">Override your input files with style.</p>
						</div>
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i> Home</a></li>
							<li><a href="#">Forms</a></li>
							<li class="active">Drag &amp; Drop File Upload</li>
						</ul>
					</div>
					<div class="container-fluid">
						<div class="row">
