...
<html>
	<head>
		<title>Chartist | Klorofil Pro - Bootstrap Admin Dashboard Template</title>
		<meta charset="utf-8">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu logged-user-menu">
									...
									<li><a href="appviews_inbox"><i class="ti-email"></i> <span>Message</span></a></li>
						...
						<li class="panel">
							...
							<div id="appViews" class="collapse ">
								<ul class="submenu">
									...
									<li><a href="appviews_inbox">Inbox <span class="badge">8</span></a></li>
						...
						<li class="panel">
							...
							<div id="charts" class="collapse in">
								<ul class="submenu">
									...
									<li><a href="charts-chartist" class="active">Chartist</a></li>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							...
							<p class="page-subtitle">Highly customizable responsive simple charts.</p>
						</div>
						<ul class="breadcrumb">
