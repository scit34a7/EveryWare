...
public interface ApprovalMapper {
	...
	//결재선id로 결재선 객체 검색
	public ApprovalLineVO findApprovalLineById(int eApprovalLine_id);	//user_id가 이름 / 부서  / 직책 의 형태
	public ApprovalLineVO findApprovalLineById2(int eApprovalLine_id);	//user_id가 진짜 user_id
