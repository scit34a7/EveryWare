...
public class R_reservationVO {
	...
	public R_reservationVO(String r_reservation_type, String resource_id, String r_reservation_sdate,
			String r_reservation_fdate, String color) {
		super();
	...
	public R_reservationVO(String r_reservation_id, String r_reservation_type, String resource_id,
			String r_reservation_sdate, String r_reservation_fdate, String color) {
		super();
	...
	public String toString() {
		return "{resourceId: '"+resource_id+"', id : '"+R_reservation_id+"',title : '"+R_reservation_type+"', start: '"+ r_reservation_sdate +"', end: '"+ r_reservation_fdate +"' , color : '"+ color +"'}";
	}
